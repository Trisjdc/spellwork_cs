...
namespace SpellWork.Spell
{
    ...
    public enum AuraType
    {
        ...
        SPELL_AURA_194 = 194,           // unused
        SPELL_AURA_195 = 195,           // unused
        ...
        SPELL_AURA_MOD_ENEMY_DODGE_PCT = 251,
        SPELL_AURA_252 = 252,
        SPELL_AURA_253 = 253,
        SPELL_AURA_254 = 254,
        SPELL_AURA_255 = 255,
        ...
        SPELL_AURA_259 = 259,
        SPELL_AURA_260 = 260,
        SPELL_AURA_261 = 261,           // Phasing (2 spells, 1 of which is test spell)
    ...
    public enum Targets
    {
        ...
        TARGET_UNK4 = 4,                 // random nearby ally? (6 spells)
        TARGET_PET = 5,
        ...
        TARGET_10 = 10,                // unused
        TARGET_UNK11 = 11,                // 1 spell only - 4 (EffectImplicitTargetA)
        TARGET_12 = 12,                // unused
        TARGET_13 = 13,                // unused
        TARGET_14 = 14,                // unused
        ...
        TARGET_ALL_FRIENDLY_IN_AREA_CHANNELED = 29,             // not confirmed, very few spells have it and part of them are benefical, another part unknown
        ...
        TARGET_UNK55 = 55,                // 2 spells - 1953, 29525 (ImplicitTargetB) (leap forward)
        TARGET_ALL_RAID_AROUND_CASTER = 56,
        TARGET_SINGLE_FRIEND_2 = 57,
        TARGET_UNK58 = 58,                // 2 spells - 30080, 46484 (spread disase?)
        TARGET_ALL_FRIENDLY_UNITS_IN_FRONTAL_CONE = 59,         // Breath: Relitalize, Breath: Haste
        TARGET_NARROW_FRONTAL_CONE = 60,
        TARGET_AREAEFFECT_PARTY_AND_CLASS = 61,
        TARGET_UNK62 = 62,                // 1 test summon spell - 27802
        ...
        TARGET_68 = 68,                // unused
        TARGET_69 = 69,                // unused
        TARGET_UNK70 = 70,                // 1 spell - 45105 (ImplicitTargetA) (charge to object)
        TARGET_71 = 71,                // unused
        ...
        TARGET_SELF2 = 87,
        TARGET_UNK88 = 88,                // 10 spells, all have Persistent Area Aura effects, target location
        TARGET_89 = 89,                // unused
        TARGET_NONCOMBAT_PET = 90,
        TARGET_91 = 91,                // unused
        TARGET_92 = 92,                // unused
        TARGET_UNK93 = 93,                // 1 spell only - 51640 (ImplicitTargetB1)
    };
